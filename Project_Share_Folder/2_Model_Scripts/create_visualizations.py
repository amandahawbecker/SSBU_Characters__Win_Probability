...
try:
    feature_importance = pd.read_csv('feature_importance_enhanced.csv')
    enhanced = True
except:
    feature_importance = pd.read_csv('feature_importance_classifier.csv')
    enhanced = False
...
plt.tight_layout()
plt.savefig('winrate_distribution.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('top_matchups.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('character_attributes.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('matchup_matrix_heatmap.png', dpi=300, bbox_inches='tight')
...
try:
    results = pd.read_csv('classifier_binary_results.csv')
...
plt.tight_layout()
plt.savefig('feature_type_breakdown.png', dpi=300, bbox_inches='tight')
